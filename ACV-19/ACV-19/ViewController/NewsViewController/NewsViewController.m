...
- (void)viewDidLoad {
    ...
    [NavigationTop initNavigationItemsTopWithTitle:@"News" leftImageName:@"icons-back.png" leftAction:@selector(navigationActionLeft) rightImageName:@"" rightAction:nil atView:self];
...
- (void)getNews {
    ...
    [APIClients getNews:^(id  _Nullable responseObject) {
        _textDataEmpty.hidden = YES;
